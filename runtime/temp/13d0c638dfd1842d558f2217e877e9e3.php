<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/www/wwwroot/vorp.top/application/templates/pc/merchant/default/goods/link.html";i:1539744090;s:73:"/www/wwwroot/vorp.top/application/templates/pc/merchant/default/base.html";i:1539744040;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
    <head>
        <meta charset="utf-8">
...
<div class="row">
	<div class="col-sm-12">
		<div class="card-box">
			<div class="row">
				<div class="col-lg-12 m-b-30"><span style="font-size: 19px;">商品名称：</span><?php echo $goods['name']; ?></div>
				<div class="col-lg-12 m-b-30">
                    <h4 class="header-title m-t-0">1、商品购买地址</h4>
					<a href="<?php echo $goods['link']; ?>" target="_blank"><?php echo $goods['link']; ?></a>
					<?php if(sysconf('site_domain_short')!==''): ?>
                    <h4 class="header-title m-t-0">2、短网址</h4>
					<a href="<?php echo $short_link; ?>" target="_blank"><?php echo $short_link; ?></a>
					<?php endif; ?>
					<br>
					<br>
					<?php if($goods['link_status']==1): ?>
					<a href="<?php echo url('user/closelink'); ?>?type=details&goods_id=<?php echo $goods['id']; ?>&status=0" class="btn btn-purple waves-effect waves-light">关闭链接</a>
					<?php else: ?>
					<a href="<?php echo url('user/closelink'); ?>?type=details&goods_id=<?php echo $goods['id']; ?>&status=1" class="btn btn-purple waves-effect waves-light">开启链接</a>
					<?php endif; ?>
					<a href="<?php echo url('user/relink'); ?>?type=details&goods_id=<?php echo $goods['id']; ?>" class="btn btn-purple waves-effect waves-light">重置链接</a>
				</div>
				<!-- end col -->
				<div class="col-lg-12">
                    <h4 class="header-title m-t-0">3、二维码地址</h4>
					<img src="<?php echo generate_qrcode_link($goods['link']); ?>" alt="">
				</div>
				<!-- end col -->
			</div>
			<!-- end row -->
