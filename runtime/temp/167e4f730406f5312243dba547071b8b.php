<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/www/wwwroot/vorp.top/application/templates/pc/manage/default/goods/index.html";i:1539744082;s:74:"/www/wwwroot/vorp.top/application/templates/pc/manage/default/content.html";i:1539744038;}*/ ?>
<div class="ibox">
...
<form class="layui-form layui-form-pane form-search" action="__SELF__" onsubmit="return false" method="get">
    ...
    <div class="layui-form-item layui-inline">
        ...
        <div class="layui-input-inline">
            <input name="name" value="<?php echo (\think\Request::instance()->get('name') ?: ''); ?>" placeholder="请输入商品名" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item layui-inline">
...
<form onsubmit="return false;" data-auto="true" method="post">
    ...
    <table class="layui-table" lay-skin="line" lay-size="sm">
        ...
        <tr>
            ...
            <td style="width: 13%;" ><a href="<?php echo sysconf('site_shop_domain'); ?>/details/<?php echo $v['link']; ?>" target="_blank"><?php echo $v['name']; ?></a></td>
