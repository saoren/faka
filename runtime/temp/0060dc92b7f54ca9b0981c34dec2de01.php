<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"/www/wwwroot/vorp.top/application/templates/pc/merchant/default/user/password.html";i:1539744088;s:73:"/www/wwwroot/vorp.top/application/templates/pc/merchant/default/base.html";i:1539744040;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
    <head>
        <meta charset="utf-8">
				...
				<div class="col-lg-12">
					<form class="form-horizontal" role="form" action="" method="post">
						...
						<div class="form-group">
							...
							<div class="col-md-10">
                                <input name="new_password2" type="text" class="form-control" value="">
							</div>
						</div>
						<div class="form-group">
