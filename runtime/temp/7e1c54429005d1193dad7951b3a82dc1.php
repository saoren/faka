<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"/www/wwwroot/vorp.top/application/templates/pc/admin/default/user/form.html";i:1539744050;}*/ ?>
<form class="layui-form layui-box" style='padding:25px 30px 20px 0' action="__SELF__" data-auto="true" method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <?php else: ?>
            <label class="think-checkbox">
                <input type="checkbox" name="authorize[]" value="<?php echo $authorize['id']; ?>" lay-ignore> <?php echo $authorize['title']; ?>
            </label>
