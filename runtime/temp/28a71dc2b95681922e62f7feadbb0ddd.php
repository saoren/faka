<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/www/wwwroot/vorp.top/application/templates/pc/merchant/default/cash/index.html";i:1539744086;s:73:"/www/wwwroot/vorp.top/application/templates/pc/merchant/default/base.html";i:1539744040;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
    <head>
        <meta charset="utf-8">
...
<div class="row">
	<div class="col-sm-12">
		<div class="card-box">
			<div class="row">
				<div class="col-sm-12">
					<a href="<?php echo url('apply'); ?>" class="btn btn-purple waves-effect waves-light">申请提现</a>
				</div>
			</div>
			<!-- end row -->
			<div class="row">
				<table class="table table-striped m-0">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo $v['actual_money']; ?></td>
							<td>
								<?php switch($v['status']): case "0": ?>审核中<?php break; case "1": ?>提现成功<?php break; case "2": ?>审核未通过<?php break; endswitch; ?>
							</td>
							<td><?php if($v['status']==1): ?><?php echo date("Y-m-d H:i:s",$v['complete_at']); endif; ?></td>
						</tr>
						<?php endforeach; ?>
					</tbody>
				</table>
