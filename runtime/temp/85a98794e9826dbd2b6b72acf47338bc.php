<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"/www/wwwroot/vorp.top/application/templates/pc/manage/default/channel_account/form.html";i:1539744080;}*/ ?>
<style>
.rate_type{
...
<form class="layui-form layui-box" style='padding:25px 30px 20px 0' action="__SELF__" data-auto="true" method="post">
	...
	<div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="highrate" value="<?php echo (isset($account['highrate']) && ($account['highrate'] !== '')?$account['highrate']:''); ?>" placeholder="请输入封顶费率" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    	<label class="layui-form-label">成本费率(‰)</label>
      	  <div class="layui-input-inline">
            <input type="text" name="costrate" value="<?php echo (isset($account['costrate']) && ($account['costrate'] !== '')?$account['costrate']:''); ?>" placeholder="请输入成本费率" class="layui-input">
        </div>
    </div>
	</div>
