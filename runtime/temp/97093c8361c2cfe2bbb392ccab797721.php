<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/www/wwwroot/vorp.top/application/templates/pc/merchant/default/cash/apply.html";i:1541750644;s:73:"/www/wwwroot/vorp.top/application/templates/pc/merchant/default/base.html";i:1539744040;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
    <head>
        <meta charset="utf-8">
            ...
            <div class="row">
                <form class="form-horizontal" role="form" action="" method="post" onsubmit="return beforeSubmit()">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input name="money" type="text" class="form-control" value="<?php echo $todayCanCashNum; ?>" readonly>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input name="money" type="text" class="form-control" value="<?php echo $_user['money']; ?>" readonly>
                        </div>
                        <div class="col-md-6">
                            <p class="form-control-static">不可提现金额：<span style="color:red"><?php echo $_user['freeze_money']; ?></span>元
                            </p>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input name="fee" type="text" class="form-control"
                                   value="<?php if(sysconf('cash_fee_type')==100): ?><?php echo sysconf('cash_fee'); ?>%<?php else: ?><?php echo sysconf('cash_fee'); ?>元<?php endif; ?>"
                                   readonly>
                        </div>
                        <div class="col-md-6">
                            <p class="form-control-static"></p>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <p class="form-control-static">注：最低提现金额<?php echo sysconf('cash_min_money'); ?>元</p>
                        </div>
                    </div>
                    <div class="form-group">
