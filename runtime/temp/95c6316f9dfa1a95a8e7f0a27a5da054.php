<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"/www/wwwroot/vorp.top/application/templates/pc/admin/default/config/file.html";i:1539744048;s:73:"/www/wwwroot/vorp.top/application/templates/pc/admin/default/content.html";i:1539744034;}*/ ?>
<div class="ibox">
...
<form onsubmit="return false;" action="__SELF__" data-auto="true" method="post" class='form-horizontal layui-form' style='padding-top:20px'>
    ...
    <div class="form-group" data-storage-type="oss">
        <label class="col-sm-2 control-label">SecretKey <span class="nowrap">(安全密钥)</span></label>
        <div class='col-sm-8'>
            <input type="password" name="storage_oss_secret" required="required" value="<?php echo sysconf('storage_oss_secret'); ?>" maxlength="30"
