<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"/www/wwwroot/vorp.top/application/templates/pc/merchant/default/message/index.html";i:1539744088;s:73:"/www/wwwroot/vorp.top/application/templates/pc/merchant/default/base.html";i:1539744040;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
    <head>
        <meta charset="utf-8">
					...
					<form class="form-inline" role="form" action="" method="get">
						<div class="form-group">
							<select name="status" class="form-control">
								...
								<option value="1" <?php if(\think\Request::instance()->get('status')=='1'): ?>selected<?php endif; ?>>已读取</option>
								<option value="2" <?php if(\think\Request::instance()->get('status')=='2'): ?>selected<?php endif; ?>>未读取</option>
							</select>
						</div>
			...
			<div class="row">
				<table class="table table-striped m-0">
					...
					<tbody>
						...
						<tr>
							<td><?php if($v['from_id']==0): ?>系统<?php else: ?><?php echo $v['fromUser']['username']; endif; ?></td>
