<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"/www/wwwroot/vorp.top/application/templates/pc/merchant/default/invite_code/index.html";i:1539744086;s:73:"/www/wwwroot/vorp.top/application/templates/pc/merchant/default/base.html";i:1539744040;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
    <head>
        <meta charset="utf-8">
				...
				<div class="col-sm-12">
					<form class="form-inline" role="form" action="" method="get">
	                    <div class="form-group">
							<input name="code" type="text" class="form-control" placeholder="邀请码" value="<?php echo (\think\Request::instance()->get('code') ?: ''); ?>">
	                    </div>
						<div class="form-group">
						...
						<div class="form-group">
							添加时间：<input class="form-control input-daterange-datepicker"  style="width:200px;" type="text" name="create_at" value="<?php echo urldecode(\think\Request::instance()->get('create_at')); ?>" placeholder="点击选择查询日期">
						</div>
						<div class="form-group">
							过期时间：<input class="form-control input-daterange-datepicker"  style="width:200px;" type="text" name="expire_at" value="<?php echo urldecode(\think\Request::instance()->get('expire_at')); ?>" placeholder="点击选择查询日期">
						</div>
						<button type="submit" class="btn btn-purple waves-effect waves-light"><i class="fa fa-search"></i> 搜索</button>
	                </form>
				</div>
				<div class="col-sm-12">
					<a href="<?php echo url('add'); ?>" class="pull-right btn btn-purple waves-effect waves-light">生成要邀请码</a>
				</div>
			</div>
			<!-- end row -->
			<div class="row">
