<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"/www/wwwroot/vorp.top/application/templates/pc/shop/default//goods.html";i:1538286654;s:71:"/www/wwwroot/vorp.top/application/templates/pc/shop/default/layout.html";i:1543624690;s:71:"/www/wwwroot/vorp.top/application/templates/pc/shop/default/footer.html";i:1539744030;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<li><span class="span_up">商品名称</span>
    <p class="big_txt" title="<?php echo $goods['name']; ?>"><?php echo $goods['name']; ?></p>
    <script>
        $(function() {
            selectgoodid();
        })
    </script>
    <input type="hidden" name="goodid" id="goodid" value="<?php echo $goods['id']; ?>">
    <input type="hidden" name="cateid" id="cateid" value="<?php echo $goods['cate_id']; ?>">
