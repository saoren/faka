<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"/www/wwwroot/vorp.top/application/templates/pc/merchant/default/goods_category/index.html";i:1539744086;s:73:"/www/wwwroot/vorp.top/application/templates/pc/merchant/default/base.html";i:1539744040;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
    <head>
        <meta charset="utf-8">
...
<div class="row">
	<div class="col-sm-12">
		<div class="card-box">
			<div class="row">
				<form class="form-inline" role="form" action="<?php echo url('add'); ?>" method="post">
				...
				<table class="table table-striped m-0">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<input onchange="change_status(this,<?php echo $v['id']; ?>)" type="checkbox" data-plugin="switchery" data-color="#2bb309" data-size="small" data-switchery="true" style="display: none;" <?php if($v['status']==1): ?>checked<?php endif; ?>>
							</td>
							<td><?php echo date("Y-m-d H:i:s",$v['create_at']); ?></td>
							<td>
                                <a href="<?php echo url('link'); ?>?id=<?php echo $v['id']; ?>">链接</a>
								<span>|</span>
                                <a href="<?php echo url('goods/index'); ?>?cate_id=<?php echo $v['id']; ?>">商品</a>
								<span>|</span>
                                <a href="<?php echo url('goods_card/index'); ?>?cate_id=<?php echo $v['id']; ?>">库存卡</a>
								<span>|</span>
