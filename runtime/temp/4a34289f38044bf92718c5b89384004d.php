<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"/www/wwwroot/vorp.top/application/templates/pc/merchant/default/goods_card/ashbin.html";i:1539744084;s:73:"/www/wwwroot/vorp.top/application/templates/pc/merchant/default/base.html";i:1539744040;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
    <head>
        <meta charset="utf-8">
					...
					<form class="form-inline" role="form" action="" method="get">
	                    ...
	                    <div class="form-group">
							<select name="goods_id" class="form-control">
								<option value="" <?php if(\think\Request::instance()->get('goods_id')==''): ?>selected<?php endif; ?>>全部商品</option>
								<?php foreach($goodsList as $v): ?>
								<option value="<?php echo $v['id']; ?>" <?php if(\think\Request::instance()->get('goods_id')==$v['id']): ?>selected<?php endif; ?>><?php echo $v['name']; ?></option>
								<?php endforeach; ?>
							</select>
	                    </div>
	                    <!-- <div class="form-group">
							<select name="status" class="form-control">
								...
								<option value="1" <?php if(\think\Request::instance()->get('status')=='1'): ?>selected<?php endif; ?>>未售出</option>
								<option value="2" <?php if(\think\Request::instance()->get('status')=='2'): ?>selected<?php endif; ?>>已售出</option>
							</select>
	                    </div> -->
