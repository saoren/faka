...
class HenglongWxScan extends Pay
{
    ...
    public function order($outTradeNo,$subject,$totalAmount)
    {
        ...
        $params['pay_bankcode'] = '902';
        $params['pay_notifyurl'] = Request::instance()->domain().'/pay/notify/HenglongWxScan';
        $params['pay_callbackurl'] = Request::instance()->domain().'/pay/page/HenglongWxScan';
